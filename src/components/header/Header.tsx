                ...
                <div className={"header"}>
                    ...
                    { currentLanguage &&
                        <div className="language-select">
                            <button onClick={() => setCurrentLanguage("lv")}
                                    style={{display: currentLanguage.includes("lv") ? "none" : "block"}}><img src={Lv}
                                                                                                              alt="LV"/>
                            </button>
                            <button onClick={() => setCurrentLanguage("en")}
                                    style={{display: currentLanguage.includes("en") ? "none" : "block"}}><img src={En}
                                                                                                              alt="EN"/>
                            </button>
                            <button onClick={() => setCurrentLanguage("ru")}
                                    style={{display: currentLanguage.includes("ru") ? "none" : "block"}}><img src={Ru}
                                                                                                              alt="RU"/>
                            </button>
                        </div>
                    }
